...
public:
    ...
    // Optimisation test #01
    void testOptimisation01(void)
    {
        Basis basis(1.935801664793151,      2.829683956491218,     14,     1.3);

        Density density(basis);

        arma::vec rVals = arma::linspace(-10,10,10);
        arma::vec zVals = arma::linspace(-10,10,10);
        ...
        TS_ASSERT_DELTA(arma::norm(res1 - res2), 0.0, 1e-14);
        TS_ASSERT_DELTA(arma::norm(res1 - resOp), 0.0, 1e-14);
    }
};